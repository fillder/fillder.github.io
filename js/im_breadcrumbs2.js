...
function generateMainMenu() {
   ...
   function createMenuItem(displayName, url) {
      const listItem = document.createElement("li");
      const link = document.createElement("a");
      link.href = url;
   ...
   function createSubMenu(children) {
      ...
      for (const [url, value] of Object.entries(children)) {
         const listItem = createMenuItem(value.displayName, url);
   ...
   const homeMenuItem = createMenuItem(siteHierarchy["/index.html"].displayName, "/index.html");
   ...
   for (const [url, value] of Object.entries(siteHierarchy["/index.html"].children)) {
      const menuItem = createMenuItem(value.displayName, url);
