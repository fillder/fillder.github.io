...
ifKnapper.forEach((knapp) => {
   knapp.addEventListener("click", () => {
      ...
      const seksjon = document.querySelector('.artikkelSeksjon[data-seksjon="' + knappID + '"]'); // Henter den tilsvarende seksjonen
      ...
      if (seksjon.classList.contains("synlig")) {
         ...
         // Ellers gjør den synlig og legg til aktiv-status
      ...
      detailsElements.forEach((detailsEl) => {
         detailsEl.addEventListener("click", () => {
            const sectionEl = detailsEl.closest(".artikkelSeksjon");
